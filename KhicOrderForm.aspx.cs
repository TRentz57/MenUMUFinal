...
public partial class KhicOrderForm : System.Web.UI.Page
{
    SqlConnection conn;
    SqlCommand cmd;
    SqlDataReader dr;
    ...
    protected void DeleteBtn_Click(object sender, EventArgs e)
    {
        ...
        //foreach (ListItem listItem in BNBListBox.Items)
        //{
        ...
        //{
        //    BNBListBox.Items.Remove(listItem);
        //}
    }
    ...
    protected void SubmitBtn_Click(object sender, EventArgs e)
    {
        ...
        Session["lbl2"] = realPriceLbl.Text;
       Session["lbx2"] = realWaitLbl1.Text;
        Session["wrd2"] = x;
       Response.Redirect("~/ThankKhic.aspx");

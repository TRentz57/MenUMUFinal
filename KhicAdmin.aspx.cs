...
using System.Data;
public partial class KhicAdmin : System.Web.UI.Page
{
    SqlConnection conn;
    SqlCommand cmd;
    SqlDataReader dr;
    ...
    private void BindData()
    {
        ...
        string test2 = "SELECT * FROM KhicTable";
    ...
    protected void AddFoodButton_Click(object sender, EventArgs e)
    {
        ...
        cmd.CommandText = "INSERT INTO KhicTable (FoodType, Price, Allergies, Wait, FoodId) VALUES ('"
